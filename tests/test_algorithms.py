...
config = {
    "plots_flag": False,
    "search_radius": 10,
    "force_center": {"state": False},
    "offset": {"x": 0.5, "y": 0.5},
    "reference_center": {"x": 50, "y": 50},
    "outlier_distance": {"x": 50, "y": 50},
    "peak_region": {"min": 100, "max": 140},
    "canny": {"sigma": 10, "low_threshold": 0.5, "high_threshold": 0.99},
    "hough": {"maximum_rank": 1, "outlier_distance": {"x": 10, "y": 10}},
...
def test_calculate_detector_center_on_a_frame():
    ...
    center = calculate_detector_center_on_a_frame(
        calibrated_data=calibrated_data,
        memory_cell_id=memory_cell_id,
        config=config,
        PF8Config=PF8Config,
    )
